...
const Home = async () => {
  return (
    <div className="relative mt-20 min-h-screen flex flex-col items-center w-full">
      <Suspense
        fallback={
          <h1 className="text-2xl font-bold text-white h-full flex items-center justify-center w-full -mt-20">
            Loading...
          </h1>
        }
      >
      ...
      <StickyAddButton dir="projects/new-project" />
    </div>
  );
};
