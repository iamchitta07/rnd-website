const BackGroundGrid = () => {
  return (
    <div className="absolute inset-0 -z-10 h-full w-full bg-black/99">
      {/* The Grid Mask */}
      <div
        className="absolute inset-0 h-full w-full bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:50px_50px]"
        style={{
